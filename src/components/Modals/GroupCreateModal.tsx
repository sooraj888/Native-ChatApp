...
import {createGroupApi, createGroupApiType} from '../../api/groupApi';
import axios, {AxiosHeaders} from 'axios';

const GroupCreateModal = ({visible, setVisible, user}: any) => {
  ...
  const handleOnCreateGroup = async () => {
    ...
    const {data, error, errorMessage}: createGroupApiType =
  ...
  const handleOnRemoveUserFromGroup = (id: string) => {
        ...
        <View style={styles.container}>
          <View style={[styles.scrollContainer]}>
            ...
            <Input
              ...
              style={[styles.input]}></Input>
            <Button style={styles.createButton} onPress={handleOnCreateGroup}>
